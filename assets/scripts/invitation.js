...
const TRANSLATIONS = {
  ...
  en: {
    ...
    sangeet_where: "The Rosewood Terrace<br>9 Meadow Court, Valsad, Gujarat",
    sangeet_dress: "Festive colour — come ready to dance until the lights go up.",
    haldi_title: "Fulo wali Haldi",
    haldi_when: "10:00 AM · Sunday, 13 December 2026",
    haldi_where: "The Courtyard<br>21 Sunflower Street, Valsad, Gujarat",
    haldi_dress: "Yellow and bright — petals and turmeric will fly, so wear something washable.",
    wedding_title: "The Wedding",
    wedding_when: "7:00 PM · Sunday, 13 December 2026",
    wedding_where: "The Old Botanical Hall<br>12 Garden Lane, Valsad, Gujarat",
  ...
  hi: {
    ...
    sangeet_where: "द रोज़वुड टैरेस<br>९ मेडो कोर्ट, वलसाड, गुजरात",
    sangeet_dress: "रंग-बिरंगे परिधान — रात भर थिरकने की तैयारी के साथ आइए।",
    haldi_title: "फूलों वाली हल्दी",
    haldi_when: "प्रातः १०:०० बजे · रविवार, १३ दिसम्बर २०२६",
    haldi_where: "द कोर्टयार्ड<br>२१ सनफ़्लावर स्ट्रीट, वलसाड, गुजरात",
    haldi_dress: "पीले और चटख रंग — फूल और हल्दी खूब उड़ेंगे, इसलिए ऐसा पहनें जो आसानी से धुल जाए।",
    wedding_title: "विवाह",
    wedding_when: "सायं ७:०० बजे · रविवार, १३ दिसम्बर २०२६",
    wedding_where: "द ओल्ड बोटैनिकल हॉल<br>१२ गार्डन लेन, वलसाड, गुजरात",
  ...
  mr: {
    ...
    sangeet_where: "द रोझवूड टेरेस<br>९ मेडो कोर्ट, वलसाड, गुजरात",
    sangeet_dress: "रंगीबेरंगी पोशाख — रात्रभर नाचायच्या तयारीनेच या.",
    haldi_title: "फुलांची हळद",
    haldi_when: "सकाळी १०:०० वा. · रविवार, १३ डिसेंबर २०२६",
    haldi_where: "द कोर्टयार्ड<br>२१ सनफ्लॉवर स्ट्रीट, वलसाड, गुजरात",
    haldi_dress: "पिवळे आणि उठावदार रंग — फुलं आणि हळद भरपूर उधळणार, त्यामुळे धुता येतील असे कपडे घाला.",
    wedding_title: "विवाह सोहळा",
    wedding_when: "सायं. ७:०० वा. · रविवार, १३ डिसेंबर २०२६",
    wedding_where: "द ओल्ड बोटॅनिकल हॉल<br>१२ गार्डन लेन, वलसाड, गुजरात",
  ...
  gu: {
    ...
    sangeet_where: "ધ રોઝવૂડ ટેરેસ<br>૯ મેડો કોર્ટ, વલસાડ, ગુજરાત",
    sangeet_dress: "રંગીન પોશાક — આખી રાત નાચવાની તૈયારી સાથે જ આવજો.",
    haldi_title: "ફૂલોવાળી હળદી",
    haldi_when: "સવારે ૧૦:૦૦ · રવિવાર, ૧૩ ડિસેમ્બર ૨૦૨૬",
    haldi_where: "ધ કોર્ટયાર્ડ<br>૨૧ સનફ્લાવર સ્ટ્રીટ, વલસાડ, ગુજરાત",
    haldi_dress: "પીળા અને તેજસ્વી રંગો — ફૂલ અને હળદર ખૂબ ઊડશે, એટલે ધોવાઈ જાય એવું પહેરજો.",
    wedding_title: "લગ્ન",
    wedding_when: "સાંજે ૭:૦૦ · રવિવાર, ૧૩ ડિસેમ્બર ૨૦૨૬",
    wedding_where: "ધ ઓલ્ડ બોટેનિકલ હોલ<br>૧૨ ગાર્ડન લેન, વલસાડ, ગુજરાત",
